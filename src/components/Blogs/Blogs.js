    ...
    return (
        <div className='mx-20'>
            <div className='my-10 border border-slate-300 bg-slate-200'>
                ...
                <p className='p-5 text-gray-500'>The React Context API is a way for a React app to effectively produce global variables which will be passed around. This is often the choice to "prop drilling" or moving props from grandparent to child to parent, and so on. Context is additionally touted as a neater, lighter approach to state management using Redux.
            ...
            <div className='border border-slate-300 bg-slate-200'>
                ...
                <p className='px-5 pb-5 text-gray-500 '>A semantic tag clearly describes its meaning to both the browser and the developer.
